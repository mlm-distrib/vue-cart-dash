        ...
        <form>
          <div class="products">
            ...
            <div class="order-buttons">
              ...
              <v-btn slot="activator" color="primary" to="/payment" dark small>
                <v-icon small>check_circle</v-icon>&nbsp;&nbsp;Place Order
              </v-btn>
            </div>
          </div>
        </form>
...
export default {
  ...
  computed: {
    ...
    return this.cartDetails.reduce(function(total, item){
